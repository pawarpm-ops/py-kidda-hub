          ...
          <div className="relative z-10 grid items-end gap-5 xl:grid-cols-[0.88fr_1.12fr]">
            <div className="pb-4">
              <div className="flex flex-wrap gap-2">
                ...
                <div className="inline-flex rounded-full border border-emerald-300/40 bg-emerald-300/10 px-3 py-1 text-xs font-bold text-emerald-100">Cloud sync test • GitHub Desktop</div>
              </div>
